...
export default function Navbar() {
  ...
  const handlePrefetch = () => {
    // Prefetch zware resources op hover/touch voor sneller navigeren
  };
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          <span className="text-white">{clientConfig.naam.split(" ")[0]}</span>
        ...
        <div className="md:hidden border-t border-white/5 bg-[#0a0a0f]/98 px-6 py-4 flex flex-col gap-4">
          ...
          <div className="pt-2 border-t border-white/10">
            <a
              href="#contact"
              onClick={() => setOpen(false)}
              className="block text-sm font-medium px-4 py-2.5 rounded-lg text-center text-white"
              style={{
                backgroundColor: clientConfig.kleur.primary,
                touchAction: "manipulation",
              }}
