...
export default function ContactForm() {
  ...
  const primaryStyle = { borderColor: clientConfig.kleur.primary };
    ...
    return (
      <div className="text-center py-16 px-8 rounded-2xl bg-white/5 border border-white/10">
        ...
        <p className="text-white/50 text-sm">
          We reageren zo snel mogelijk, uiterlijk binnen 24 uur.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={4}
          placeholder="Stel een vraag of vertel wat je nodig hebt..."
      ...
      <p className="text-center text-white/25 text-xs">
        Geen spam. Wij reageren persoonlijk binnen 24 uur.
      </p>
    </form>
  );
}
