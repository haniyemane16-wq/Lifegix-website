...
const items = [
  ...
  },
  {
    ...
    a: "Websites starten vanaf €499 eenmalig plus €49 per maand voor hosting, onderhoud en support. Gebruik de ROI-calculator voor een berekening op maat op basis van jouw situatie.",
  },
  {
