...
async function addNotionKlant(data: {
  ...
  const properties: Record<string, unknown> = {
    ...
    "Geworven door":       data.referral ? { rich_text: [{ text: { content: data.referral } }] } : undefined,
  };
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #0a0a0f; color: #ededed; border-radius: 12px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            ${referral ? `<tr><td style="padding: 8px 0; color: #9ca3af;">Geworven door</td><td style="padding: 8px 0; font-weight: 600; color: #22c55e;">${escapeHtml(referral)} 💰</td></tr>` : ""}
